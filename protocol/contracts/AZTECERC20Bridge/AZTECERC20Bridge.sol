...
// [ ["01cf7cc93bfbf7b2c5f04a3bc9cb8b72bbcf2defcabdceb09860c493bdf1588d"] , ["08d554bf59102bbb961ba81107ec71785ef9ce6638e5332b6c1a58b87447d181"] , ["204e5d81d86c561f9344ad5f122a625f259996b065b80cbbe74a9ad97b6d7cc2"] , ["02cb2a424885c9e412b94c40905b359e3043275cd29f5b557f008cd0a3e0c0dc"] , ]
...
contract AZTECERC20Bridge {
    ...
    **/
    constructor(bytes32[4] memory _setupPubKey, address _token, uint256 _scalingFactor) public {
        ...
        emit Created(_domainHash, address(this));
    }
    ...
    **/
    function validateInputNote(bytes32[6] memory note, bytes32[3] memory signature, uint challenge, bytes32 domainHashT) internal {
        bytes32 noteHash;
        ...
        address owner = ecrecover(signatureMessage, uint8(uint(signature[1])), signature[1], signature[2]);
    ...
    */
    function confidentialTransfer(bytes32[6][] calldata notes, uint256 m, uint256 challenge, bytes32[3][] calldata inputSignatures, address[] calldata outputOwners, bytes calldata) external {
